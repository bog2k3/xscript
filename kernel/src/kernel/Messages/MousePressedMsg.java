...
public class MousePressedMsg extends Message 
{
	public final MouseEvent m_args;

	public MousePressedMsg(Object recipient, Object sender, MouseEvent arg0) {
	...
	public void deliver() 
	{
		...
		for (MouseListener ml : subs) {
			ml.mousePressed(m_args);
		}
	}
	
	@Override
	public String toString() {
		return "MousePressedMsg"+Message.hashString(this)+"[recipient:"+recipient+" sender:"+sender+" args:"+m_args+"]";
	}
