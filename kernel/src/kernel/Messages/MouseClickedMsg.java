...
public class MouseClickedMsg extends Message {
	
	public final MouseEvent m_args;

	public MouseClickedMsg(Object recipient, Object sender, MouseEvent arg0) {
	...
	public void deliver() 
	{
		...
		for (MouseListener ml : subs)
			ml.mouseClicked(m_args);
	}
	
	@Override
	public String toString() {
		return "MouseClickedMsg"+Message.hashString(this)+"[recipient:"+recipient+" sender:"+sender+" args:"+m_args+"]";
	}
